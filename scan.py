...
# رسم العنوان
print(text2art("Bug Scan", font='Georgia'))

# طباعة رسالة الترحيب
welcome_message = "Bug Bounty Scan by Ghassan Melhem"
instagram_message = "Don't forget to follow my In Github account (https://github.com/Ghassan0o0)"
